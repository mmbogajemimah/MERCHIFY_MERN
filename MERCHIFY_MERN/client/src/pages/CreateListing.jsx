    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <input type="text" placeholder="Address" className="border p-3 rounded-lg" id="addrress" required/>
        ...
        <div className="flex flex-col flex-1">
          ...
          <p className="text-red-700 my-2">{imageUploadError && imageUploadError}</p>
          ...
          <button className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 my-4">
            Create Listing
          </button>
        </div>
      </form>
